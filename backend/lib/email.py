...
async def send_email(
    ...
    msg = MIMEMultipart()
    msg['From'] = Header(email.from_addr, 'utf-8')  # sender email address
    msg['To'] = Header(email.send_to_addr, 'utf-8')  # target email address
    msg['Subject'] = Header(email.subject, 'utf-8')  # Subject / title
